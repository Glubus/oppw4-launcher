...
<section class="relative z-30 grid gap-3 overflow-visible rounded-lg border border-white/10 bg-card/86 p-3 shadow-[0_18px_50px_rgba(0,0,0,0.22)] backdrop-blur-md {pluginMode ? 'lg:grid-cols-[1fr_180px]' : 'lg:grid-cols-[1fr_260px_210px_180px]'}">
